...
if(isset($_POST['Mumbai'])) {
	$que="SELECT * FROM `information` WHERE pname='Mumbai'";
	$result = mysqli_query($con, $que);
}
?>
	...
	<div class="container">
		<div class="description-container" style="border: 1px solid black;">
			...
			<div class="description">
				...
				<p style="color:red; top: -10px;" >Per_Day_changes: <?php echo $rows['package']; ?> Rs</p>
			</div>
			<a href="booking_form.php" style="top: -20px; float: right; margin-right: 27%;">Book Tour</a>
		</div>
